namespace ATP.TicTacToeKata.Tests
{
    ...
    public class TicTacToeShould
    {
        ...
        [Test]
        public void MakeXWinner_GivenXReverseDiagonal()
        {
            ...
            var (allowed, message) = _ticTacToe.TakeTurn(TicTacToe.PlayerX, 2, 0);
        ...
        [Test]
        public void ReportDraw_Given9SquaresFilledAndNoWinner()
        {
            _ticTacToe.TakeTurn(TicTacToe.PlayerX, 0, 0);
